...
<header class="header-area style-1">
    ...
    <div class="main-menu">
        ...
        <ul class="menu-list">
            ...
            <li id="misc1">
                <a id="number1" href="tel:+919732300007" class="track-click" data-id="4">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    <span>
        <a href="tel:+919732300007" class="track-click" data-id="1">+91-9732300007</a>
    </span>
</div>
        </div>
    ...
    <a id="number2" class="track-click" data-id="2" href="tel:+919732300007">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <path d="M6.62 10.79a15.053 15.053 0 006.59 6.59l2.2-2.2a1 1 0 011.17-.17c1.12.56 2.38.86 3.69.86a1 1 0 011 1v3.59a1 1 0 01-1 1C10.64 22.96 1.04 13.36 1.04 4a1 1 0 011-1H5.63a1 1 0 011 1c0 1.31.3 2.57.86 3.69a1 1 0 01-.17 1.17l-2.2 2.2z" />
        </svg>
