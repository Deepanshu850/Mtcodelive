...
<head>
    ...
    <title>
        Studio Apartments for Sale in Mumbai
    </title>
    ...
    <link rel="canonical" href="https://moneytreerealty.com/category/studio-apartment-for-sale-mumbai" />
    ...
    <div class="search-container">
        <form method="GET" action="" class="search-form">
            <div class="form-group d-flex flex-wrap justify-content-center">
                <h1 style="font-size: 20px;">Studio Apartments for Sale in Mumbai</h1>
