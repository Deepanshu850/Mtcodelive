...
<head>
    ...
    <title>
        Residential Property for Sale in Goa
    </title>
    ...
    <link rel="canonical" href="https://moneytreerealty.com/category/residential-property-for-sale-goa" />
...
<body class="light-theme">
    ...
    <div class="search-container">
        <form method="GET" action="" class="search-form">
            <div class="form-group d-flex flex-wrap justify-content-center">
                <h1 style="font-size: 20px;">Residential Property for Sale in Goa</h1>
    ...
    <div class="property-container">
        ...
        $properties = filterProperties($properties, ['goa'], ['residential']);
