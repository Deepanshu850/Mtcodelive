                ...
                <div class="property-card fade-in">
                    ...
                    <div class="property-card-data">
                        ...
                        <div class="property-card-button">
                            <button class="callback-button card-button">Enquiry</button>
        ...
        toggles.forEach(function(toggle) {
            ...
            toggle.addEventListener('click', function() {
                if (text.classList.contains('expanded')) {
                    ...
                    toggle.innerHTML = 'Read more <span class="icon">▼</span>';
                } else {
                    text.classList.add('expanded');
                    toggle.innerHTML = 'Read less <span class="icon">▲</span>';
                }
            });
        });
    });
...
<style>
    ...
    .property-card-data h2 {
        grid-column: 1/4;
        grid-row: 1/2;
        text-align: center;
    }

    .property-card-data .data-grid {
        grid-column: 1/3;
        grid-row: 2/3;
    }

    .property-card-data .property-card-button {
        grid-column: 3/4;
        grid-row: 2/3;
        display: flex;
        flex-direction: column;
    ...
    .property-card-data .read-more-content {
        grid-column: 1/4;
        grid-row: 3/4;
        margin-top: 1rem;
    }
