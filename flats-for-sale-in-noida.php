...
<head>
    ...
    <meta property="og:url" content="https://moneytreerealty.com/">
    ...
    <meta property="og:image" content="https://moneytreerealty.com/assets/img/">
    ...
    <link rel="canonical" href="https://moneytreerealty.com/" />
                        ...
                        <div class="property-wrapper">
                            ...
                            <div class="content">
                                <div class="headings">
                                    ...
                                    <!-- Description -->
                                    <p class="property-description">Lorem ipsum dolor sit amet.</p>
                                    <p class="property-description">Consectetur adipiscing elit.</p>
                                </div>
                                <div class="buttons">
                                    <!-- Buttons -->
                                    <button class="property-button">View Details</button>
                                    <button class="property-button">Contact</button>
                                </div>
                                <!-- Grid Structure -->
                                <div class="property-grid">
                                    <div class="grid-item">
                                        <img src="./Screenshot_2024-08-29_130450-removebg-preview.png" alt="">
