    ...
    <body class=light-theme><noscript><iframe height=0
        ...
        <div class="property-grid">
            ...
            <?php foreach ($properties as $index => $property): ?>
                <div class="property-card" style="display: <?php echo $index < 3 ? 'block' : 'none'; ?>;" data-index="<?php echo $index; ?>">
                    <div class="property-card-content">
                        <h3><?php echo $property['name']; ?></h3>
                        <p><b>Builder:</b> <?php echo $property['builder']; ?></p>
                        <p><b>Location:</b> <?php echo implode(', ', $property['location']); ?></p>
                        <p><b>Price:</b> <?php echo $property['price']; ?></p>
                        <p><b>Type:</b> <?php echo implode(', ', $property['type']); ?></p>
                        <a href="propertydetail/<?php echo $property['link']; ?>" class="details-link">View Details</a>
                    </div>
                </div>
            <?php endforeach; ?>
        </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                let visibleCount = 3; // Initially visible cards
                ...
                readMoreBtn.addEventListener('click', function() {
                    ...
                    if (visibleCount >= propertyCards.length) {
                        readMoreBtn.style.display = 'none'; // Hide button if all cards are visible
                    }
                });
            });
        </script>
