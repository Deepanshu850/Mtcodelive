...
<head>
    ...
    <meta name="description"
        content="Get in touch with MoneyTree Realty, the leading real estate consultant in india. Contact us @ +91-9732300007 to get your dream property and reach out to us for your real estate needs." />
    <meta name="keywords"
        content="Contact Real Estate Agent, MoneyTree Realty Contact, Real Estate Delhi/NCR Contact, Property Consultant Contact, Real Estate Inquiries" />
    ...
    <meta name="subject"
        content="Reach out to MoneyTree Realty for inquiries, support, and real estate services in Delhi/NCR." />
...
<body class="light-theme">
    ...
    <div id="custom-404-page" class="container-404">
        ...
        <p class="message">The page you're looking for isn't here. Maybe it was never here to begin with.</p>
        <div class="buttons">
            <a href="/" class="btn btn-homepage">Home Page</a>
            <a href="contact.php" class="btn btn-contact">Send Message</a>
        </div>
    </div>
