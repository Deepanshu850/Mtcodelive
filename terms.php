...
<title>Terms and Conditions - MoneyTree Realty | Real Estate Services in Delhi/NCR</title>
<meta name="description" content="Review the Terms and Conditions for using MoneyTree Realty’s services and website. Understand your rights and responsibilities as a user of our real estate platform in Delhi/NCR." />
<meta name="keywords" content="Terms of Service, Legal Agreements, Real Estate Terms, User Responsibilities, MoneyTree Realty Legal, Property Service Terms Delhi/NCR" />

<meta name="Owner" content="Moneytreerealty.com" />
<meta name="Copyright" content="Moneytreereal.com" />
<meta name="classification" content="Legal Terms and Conditions of Real Estate Services" />
<meta name="distribution" content="India" />
<meta name="rating" content="General" />
<meta name="subject" content="Access and understand the terms and conditions governing your use of MoneyTree Realty’s real estate services and website." />
<meta name="audience" content="Website Users, Real Estate Clients, Service Users" />
...
<body class="light-theme">
 ...
 <script 
    ...
    <header class="header-area style-1">
        <div class="header-logo d-lg-none d-flex"> <a href="index.php"><img alt="image" class="img-fluid"
        ...
        <div class="main-menu">
            ...
            <ul class="menu-list">
                <li><img src="assets/img/logo.png" alt="" style="width: 130px;">
                </li>
                ...
                <li class="menu-item-has-children"> <a href="#" class="drop-down">Others </a><i
                    ...
                    <ul class="sub-menu">
                        ...
                        <li> <a href="calendar-tab.php" class="drop-down">CALENDAR </a> </li>
                             <li> <a href="navratree-property-mela.php" class="drop-down">EVENT</a> </li>
    ...
    <div class="container">
        ...
        <p>Welcome to MoneyTree Realty!</p>

        <p>These terms and conditions outline the rules and regulations for the use of MoneyTree Realty's Website,
            located
            at
            https://moneytreerealty.com/.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use MoneyTree
            Realty
        ...
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
            ...
            Company's
            stated services, in accordance with and subject to, prevailing law of in. Any use of the above terminology
            or
        ...
        <p>We employ the use of cookies. By accessing MoneyTree Realty, you agreed to use cookies in agreement with the
            MoneyTree Realty's Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, MoneyTree Realty and/or its licensors own the intellectual property rights for all
            material on MoneyTree Realty. All intellectual property rights are reserved. You may access this from
            MoneyTree
            Realty for your own personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from MoneyTree Realty</li>
            <li>Sell, rent or sub-license material from MoneyTree Realty</li>
            <li>Reproduce, duplicate or copy material from MoneyTree Realty</li>
            <li>Redistribute content from MoneyTree Realty</li>
        </ul>
        ...
        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas
            of the website. MoneyTree Realty does not filter, edit, publish or review Comments prior to their presence
            on
            the
            website. Comments do not reflect the views and opinions of MoneyTree Realty,its agents and/or affiliates.
            Comments
            reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
            applicable laws, MoneyTree Realty shall not be liable for the Comments or for any liability, damages or
            expenses
            caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
            website.</p>

        <p>MoneyTree Realty reserves the right to monitor all Comments and to remove any Comments which can be
            considered
        ...
        <p>You hereby grant MoneyTree Realty a non-exclusive license to use, reproduce, edit and authorize others to
            use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            records
            with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of MoneyTree
            Realty;
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you
            must inform us by sending an e-mail to MoneyTree Realty. Please include your name, your organization name,
            contact
        ...
        <p>No use of MoneyTree Realty's logo or other artwork will be allowed for linking absent a trademark license
            agreement.</p>
                    ...
                    <div class="col-xl-4 col-lg-4 mb-50">
                        <div class="footer-widget">
                            <div class="footer-logo">
                                <a href="index.html"><img src="assets/img/footer-logo.png" class="img-fluid"
                                        alt="logo"></a>
                            </div>
                            ...
                            <div class="footer-social-icon">
                                ...
                                <a href="https://www.facebook.com">
                                    <img src="assets/img/home2/icon/facebook.svg" alt="Facebook"
                                        style="width: 24px; height: 24px;">
                                </a>

                                <a href="https://www.instagram.com/moneytreerealtyofficial/">
                                    <img src="assets/img/home2/icon/insta.svg" alt="Instagram"
                                        style="width: 24px; height: 24px;">
                                </a>

                                <a href="https://www.linkedin.com/company/moneytree-realty-services/mycompany/">
                                    <img src="assets/img/home2/icon/linkedin.svg" alt="Linkedin"
                                        style="width: 24px; height: 24px;">
                                </a>
                            </div>
                        </div>
